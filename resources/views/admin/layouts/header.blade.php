<header class="header fixed-top clearfix">
    <div class="brand">
        <a href="{{route('admin')}}" class="logo">
            <img height="50" src="{{@url('images/logo.png')}}" alt="">
        </a>
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu extended logout">
                    <li><a href="{{url('account') }}"><i class=" fa fa-suitcase"></i>Profile</a></li>
...
{{-- <div class="container-fluid admin-header header bg-secondary p-1 rounded shadow">
    <div class="row mx-0">
        ...
        <div class="col-md-11 d-flex justify-content-between align-items-center">
            ...
            <div class="admin-user col-4 align-items-center hearder-nav-item">
                <a class="dropdown-toggle" href="{{ @url('account') }}">
                    @if($currentUser['user_image'])
                    <img width="50" height="50"
                        src="{{ url('images/users/' . $currentUser['user_image']) }}"
