                ...
                <div class="col-8">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control" id="product_path"
                            placeholder="Nhập tên sản phẩm" value="{{ @$product['product_path'] }}" disabled>
                    </div>
                    <div class="form-group my-3">
                        <label for="product_id">Mã sản phẩm</label>
                        <input type="text" class="form-control" id="product_id" name="product_id"
                            placeholder="Nhập mã sản phẩm" value="{{ @$product['product_id'] }}">
                    </div>
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control" id="qr_code" name="qr_code"
                            placeholder="Nhập mã QR" value="{{ @$product['qr_code'] }}">
                    </div>
                    <div class="form-group my-3">
                        <label for="origin">Nguồn gốc</label>
                        <input type="text" class="form-control" id="origin" name="origin"
                            placeholder="Nhập nguồn gốc sản phẩm" value="{{ @$product['origin'] }}">
                    </div>
                    <div class="form-group my-3">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="number" class="form-control" id="unit_cost" name="unit_cost"
                            placeholder="Nhập giá gốc" value="{{ @$product['unit_cost'] }}">
                    </div>
                    <div class="form-group my-3">
                        <label for="real_cost">Giá thực</label>
                        <input type="number" class="form-control" id="real_cost" name="real_cost"
                            placeholder="Nhập giá thực" value="{{ @$product['real_cost'] }}">
                    </div>
                    <div class="form-group my-3">
                        <label for="discount">Khuyến mại (theo %)</label>
                        <input type="number" class="form-control" id="discount" name="discount"
                            placeholder="Enter Unit Price" value="{{ @$product['discount'] }}">
                        <div class="form-group my-3">
                            <label for="product_title">sản phẩm Title</label>
                            <input type="text" class="form-control" id="product_title" name="product_title"
                                placeholder="Enter sản phẩm Title" value="{{ @$product['product_title'] }}">
                        </div>
                        <div class="form-group my-3">
